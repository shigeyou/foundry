...
const DEPT_KEYWORDS: Record<string, string[]> = {
  ...
  "eo": ["執行役員", "経営幹部", "取締役", "経営会議", "経営陣", "役員"],
  "cc-plus": ["広報", "IR", "ブランディング", "社内報", "コーポレートコミュニケーション", "ステークホルダー"],
  "dx-cocreation": ["DX推進", "デジタル変革", "データ連携", "共創", "デジタル化"],
  "diversity": ["ダイバーシティ", "女性活躍", "多様性", "インクルージョン", "障がい者", "外国人材"],
};
