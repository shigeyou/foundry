...
**【重要：財務データの注意点】**
シミュレータ技術部は海洋技術事業部向けのコンサルティング業務や海技訓練事業部向けの訓練業務を実施しているが、
事業部間の振替処理が適切に行われておらず、費用が正しく計上されていない。
このため、FY26予算上の営業損益は実態よりも悪く見えている可能性が高い。
海洋技術事業部・海技訓練事業部の営業利益は逆に過大計上の可能性がある。

**【技術的課題】**
現行シミュレータシステムは自前カスタマイズの余地が限定的。
競合他社はシミュレータを自社開発しAI等最新技術を取り入れて進化を続けており、技術格差拡大のリスクがある。

シナリオの商品化、他部門との連携、人材確保・育成、事業モデルの再構築、
そして振替処理の適正化と技術的自立の両面から多角的に考えてください。`,
