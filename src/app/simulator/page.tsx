          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-slate-900 dark:text-white">シミュレーター型</h1>
                  <p className="text-xs text-slate-500 dark:text-slate-400">予測する</p>
                </div>
              </div>
            </div>
            <ThemeToggle />
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="mb-8">
          <p className="text-slate-600 dark:text-slate-400 max-w-3xl">
            シミュレーター型は、投資判断、撤退シナリオ、競合分析など、
            将来の可能性をAIでシミュレーションするアプリケーションです。
            複数のシナリオを比較検討し、意思決定をサポートします。
          </p>
        </section>
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-12 text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 mb-6">
                メタファインダーを使って、組織に必要なシミュレーターを発見しましょう
              </p>
              <Link
                href="/meta-finder"
